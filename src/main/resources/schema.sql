...
CREATE SCHEMA IF NOT EXISTS bank_cards_management;

-- Set the schema search path
SET search_path TO bank_cards_management;

-- Creating the 'users' table
CREATE TABLE "bank_cards_management".users (
	id uuid NOT NULL,
...
CREATE TABLE "bank_cards_management".cards (
	id uuid NOT NULL,
...
-- "bank_cards_management".cards foreign keys
ALTER TABLE "bank_cards_management".cards ADD CONSTRAINT cards_users_fk FOREIGN KEY (owner_id) REFERENCES "bank_cards_management".users(id);


-- Creating the 'transactions' table
CREATE TABLE "bank_cards_management".transactions (
	id uuid NOT NULL,
	...
	CONSTRAINT transactions_sorce_cards_fk FOREIGN KEY (source_card_id) REFERENCES "bank_cards_management".cards(id),
	CONSTRAINT transactions_destination_cards_fk FOREIGN KEY (destination_card_id) REFERENCES "bank_cards_management".cards(id)
);
...
INSERT INTO "bank_cards_management".users (id, full_name, email, "password", "role") VALUES
...
INSERT INTO "bank_cards_management".cards (id, "number", owner_id, expiration_date, status, balance, transaction_limit_per_day) VALUES
...
INSERT INTO "bank_cards_management".transactions (id, source_card_id, destination_card_id, local_date_time, amount) VALUES
