 ...
 * Class UserDto
 *
 * UserDto is a Data Transfer Object (DTO) representing a user with their personal details.
 * It is used for transferring user-related data, such as the user's id, name, email, password, and role.
 */
@AllArgsConstructor
@NoArgsConstructor
@Getter
...
public class UserDto {
     ...
     * This field must be a valid email pattern and contain a non-empty value.
     */
